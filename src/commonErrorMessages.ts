...
export const defaultCommonErrorMessagesDict: ErrorsMessagesDict<CommonErrorsId, CommonErrorsDefaultLanguages> = {
  authRequired: {
    ...
    ptbr: 'Você precisa estar logado para executar esta ação.',
  },
  cantBeAnon: {
    en: 'You must be properly logged in to perform this action.',
    ptbr: 'Você precisa estar devidamente logado para executar esta ação.',
  },
  invalidArgs: {
    en: 'Invalid arguments.',
    ptbr: 'Argumentos inválidos.',
  },
  unknown: {
    en: 'An error occurred in the server, try again.',
    ptbr: 'Ocorreu um erro no servidor, tente novamente.',
  }
};
 ...
 * the current `en` and `ptbr`, call this function with your own dictionary before everything.
 *
